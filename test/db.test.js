var should = require('chai').should()
  ...
  , model = require('../nedb/model')
  , Datastore = require('../nedb/datastore')
  , Persistence = require('../nedb/storage/onDisk')
  ...
  describe('Using indexes', function () {
    ...
    describe('qupd', function(){
      it('Updating docs still works as before with indexing', function (done) {
        ...
        db.ensureIndex({ fieldName: 'a' }, function(){
          db.insert({ a: 1, b: 'hello' }, function (err, _doc1) {
            _doc1 = _doc1[0]
            db.insert({ a: 2, b: 'hello' }, function (err, _doc2) {
              ...
              db.update({b: "hello"}, { $inc: { a: 10 }, $set: { b: 'same' } }, { multi: true, qupd: true }, function (err, nr) {
                ...
                data.length.should.equal(2);
                assert.deepEqual(doc1, { a: 11, b: 'same', _id: _doc1._id });
