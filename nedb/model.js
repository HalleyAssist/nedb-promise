...
function checkKey (k, v) {
  ...
  if (k[0] === '$' && !(k === '$$date' && typeof v === 'number') && (k !== '$$deleted') && (k !== '$$indexCreated') && (k !== '$$indexRemoved') && (k !== '$$qupd')) {
    throw new Error('Field names cannot begin with the $ character (was '+k+')');
  }
